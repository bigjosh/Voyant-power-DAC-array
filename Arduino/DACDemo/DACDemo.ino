/////////////////////////////////////////////////////////////////////////////////
// Quick demo to output a ramp, step, and sin for testing. 
/////////////////////////////////////////////////////////////////////////////////
#include <SPI.h>
...
const unsigned dac_steps = 4096;// (1<<12);   // 12 bits of resolution

void loop() {

  
  for(unsigned i=0;i<dac_steps;i++) {
    
    writeMCP492x(i, SS1, SS1PORT);

  }


  for(unsigned i=0;i<dac_steps;i+=315) {    // 315 is a factor of 4095
  ...
  for(float a = 0 ; a < 2 * 3.1415 ; a+=0.02) {
   
    unsigned value = (unsigned)(
      sin( a ) * (dac_steps/2) + (dac_steps/2)
    );
